    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', justifyContent: 'space-between' }} >
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: flexDirection, justifyContent: 'center', alignItems: 'center' }}>
          ...
          <>
            ...
            <div style={{ marginTop: '20px' }} className="componentBackground2 m-4 text-left text-inherit no-underline border border-black rounded-lg max-w-xs">
              <SetAsk ownerList={ownerList} setOwnerList={setOwnerList} refreshAsksList={refreshAsksList} setRefreshAsksList={setRefreshAsksList} refreshBidsList={refreshBidsList} setRefreshBidsList={setRefreshBidsList} bidTableList={bidTableList} marketplaceContract={ETCeriaMP1pt1_address} isDisabled={isDisabled} />
            </div>
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }}>
          <Asks ownerList={ownerList} refreshAsksList={refreshAsksList} marketplaceContract={ETCeriaMP1pt1_address} />
        </div>

        {/* Centered Bids component */}
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '20px', marginBottom: '20px' }}>
          <Bids refreshBidsList={refreshBidsList} tableList={bidTableList} setTableList={setBidTableList} marketplaceContract={ETCeriaMP1pt1_address} />
        </div>
      </div>
